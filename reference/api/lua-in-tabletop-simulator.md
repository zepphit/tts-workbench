<!-- vendored from https://api.tabletopsimulator.com/lua-in-tabletop-simulator/ — do not edit, regenerate with scripts/fetch_api_docs.py -->
...
2. The result of the expression will *always* be returned. Generally, this is what you want, but it's worth being aware of.
