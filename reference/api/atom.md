<!-- vendored from https://api.tabletopsimulator.com/atom/ — do not edit, regenerate with scripts/fetch_api_docs.py -->

# Atom

![Logo](https://api.tabletopsimulator.com/img/atom/logo.png)
...
![Syntax Highlighting](https://api.tabletopsimulator.com/img/atom/syntax.png)
...
![Code Autocompletion](https://api.tabletopsimulator.com/img/atom/autocomplete.png)
...
| --- | --- |
| Get Lua Scripts | Downloads all existing scripts in a loaded Tabletop Simulator game with Atom. You will need to call Get Lua Scripts every time you change to a different game in TTS.**Shortcut:**``Ctrl`+`Shift`+`L`` |
| Save & Play | Saves all Lua files in Atom, uploads them to a loaded Tabletop Simulator game, and reloads the current game (same as Save & Play in the in-game editor).**Shortcut:**``Ctrl`+`Shift`+`S`` |

![Logo](https://api.tabletopsimulator.com/img/atom/sap1.png) ![Logo](https://api.tabletopsimulator.com/img/atom/sap2.png)
...
![Installing Atom](https://api.tabletopsimulator.com/img/atom/install.png)
...
All [print(...)](base.md#print), [log(...)](base.md#log) and error messages are sent to Atom's console. This is particularly helpful as you're able to copy text from here.
...
![Setup](https://api.tabletopsimulator.com/img/atom/setup.PNG)
...
![Tabs as Pipe Operators](https://api.tabletopsimulator.com/img/atom/pipes.PNG)
