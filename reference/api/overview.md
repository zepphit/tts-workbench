<!-- vendored from https://api.tabletopsimulator.com/overview/ — do not edit, regenerate with scripts/fetch_api_docs.py -->
...
![Overview](https://api.tabletopsimulator.com/img/overview1.png)
...
![Aton Plugin](https://api.tabletopsimulator.com/img/overview2.png)
