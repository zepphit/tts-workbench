<!-- vendored from https://api.tabletopsimulator.com/built-in-object/ — do not edit, regenerate with scripts/fetch_api_docs.py -->
...
| Custom Board | [`Custom_Board`](custom-game-objects.md#custom-board) | Snaps to table level immediately upon spawn. |
| Custom Deck | [`DeckCustom`](custom-game-objects.md#custom-deck) | *(none)* |
| Custom Figurine | [`Figurine_Custom`](custom-game-objects.md#custom-figurine) | *(none)* |
| Custom Model | [`Custom_Model`](custom-game-objects.md#custom-model) | *(none)* |
