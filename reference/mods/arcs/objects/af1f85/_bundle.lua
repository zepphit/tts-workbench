-- Bundled by luabundle {"rootModuleName":"Dice Board.af1f85.lua","version":"1.6.0"}
...
__bundle_register("Dice Board.af1f85.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
require("src/DiceBoard")
end)
__bundle_register("src/DiceBoard", function(require, _LOADED, __bundle_register, __bundle_modules)
local DiceBoard = {}
...
return __bundle_require("Dice Board.af1f85.lua")