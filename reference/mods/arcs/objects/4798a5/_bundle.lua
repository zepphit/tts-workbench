-- Bundled by luabundle {"rootModuleName":"Dice Counter.4798a5.lua","version":"1.6.0"}
...
__bundle_register("Dice Counter.4798a5.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
require("src/DiceCounter")
end)
__bundle_register("src/DiceCounter", function(require, _LOADED, __bundle_register, __bundle_modules)
-----------------------------------------------------
...
return __bundle_require("Dice Counter.4798a5.lua")