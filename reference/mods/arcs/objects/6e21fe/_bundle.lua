-- Bundled by luabundle {"rootModuleName":"Control.6e21fe.lua","version":"1.6.0"}
...
__bundle_register("Control.6e21fe.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
require("src/Control")
end)
...
return __bundle_require("Control.6e21fe.lua")